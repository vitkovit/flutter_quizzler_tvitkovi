...
class QuizBrain {
  final List<Question> _questionBank = [ //we can make this property private with _ so main function// can't change it
  ...
  bool getCorrectAnswer(int questionAnswer){
    return _questionBank[questionAnswer].questionAnswer;
  }
}
